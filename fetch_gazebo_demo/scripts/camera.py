...
def main(args):
    ...
    topics = [ 
        ...
        ('head_camera/depth_downsample/points', PointCloud2), # None :(
        ('head_camera/depth_downsample/image_raw', Image), # None :(
        ('head_camera/depth_registered/image_raw', Image), # None :(
